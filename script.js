/* RAG Web Chat — All-fixed bundle
 * - FAST/HYBRID/FULL retrieval modes
 * - Dynamic import for Transformers.js (fixes window.transformers undefined)
 * - pdf.js UMD + worker for GitHub Pages
 * - Smaller embedding model (paraphrase-MiniLM-L3-v2) for faster load
 */
...
// Ask browser to persist storage (reduce cache eviction)
...
async function ensureEmbedder(){
  ...
  try {
    ...
    addMsg('임베딩 모델 로딩에 실패했습니다. 상단 모드를 FAST로 바꾸어 사용하거나, 네트워크(CDN) 접근을 확인하세요.', 'bot');
    throw e;
  }
}
